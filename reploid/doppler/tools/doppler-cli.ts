 ...
 *
 * Usage:
 *   npx tsx doppler/tools/doppler-cli.ts run                    # Serve demo page
 *   npx tsx doppler/tools/doppler-cli.ts test <suite> [options] # Run tests
 *   npx tsx doppler/tools/doppler-cli.ts bench <suite> [options] # Run benchmarks
 *   npx tsx doppler/tools/doppler-cli.ts debug [options]        # Debug mode
 *
 * Examples:
