...
function main() {
  ...
  const knownPaths = [
    ...
    'docs/agents/conversion-protocol.md',
    'docs/agents/debug-protocol.md',
    'docs/agents/benchmark-protocol.md',
    'docs/agents/hardware-notes.md',
    'docs/agents/tooling-surface.md',
