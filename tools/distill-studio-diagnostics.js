...
const PROVENANCE_SCRIPT = fileURLToPath(new URL('./verify-training-provenance.js', import.meta.url));
...
function parseArgs(argv) {
  ...
  if (!parsed.report) {
    throw new Error('Usage: node tools/distill-studio-diagnostics.js --report <report.json> [--checkpoint <checkpoint.json>]');
  }
  return parsed;
}
