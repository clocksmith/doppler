...
const TENSOR_SEMANTIC_PATTERN = /\b(?:tensor|logit|hidden|embedding|expert|attention|softmax|norm|projection|latent|feature|weight|activation|gradient|pool|matrix|matmul|router|modelOutput|sample)\w*/iu;
