...
if (!args.source || !args.out) throw new Error('Usage: node tools/forge-chronos-bolt-capsule.js --source DIR --out DIR');
...
const candidate = { modelId: recipe.modelId, modelIR, artifacts, wgslModules: modules,
  program: { schema: 'doppler.capsule-program/v1', programBundleArtifactId: 'program', programBundleHash: bundleArtifact.hash,
