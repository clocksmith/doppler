...
const PACKAGE_CONTENT_LIMITS = Object.freeze({
  ...
  // Explicit erf GELU and activation-step binding, plus third-party module MIME:
  // Node 22.23.2/npm 10.9.8: 2,108,756 packed; same 1,780 entries.
  maxPackedSize: 2_108_756,
