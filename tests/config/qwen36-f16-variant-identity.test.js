...
const af32Config = readJson(`tests/fixtures/pre-capsule/src/config/conversion/qwen3/${AF32_MODEL_ID}.json`);
const af16Config = readJson(`tests/fixtures/pre-capsule/src/config/conversion/qwen3/${AF16_MODEL_ID}.json`);
