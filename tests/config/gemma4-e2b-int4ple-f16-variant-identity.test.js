...
assert.equal(af16Entry.weightCapsuleId, af32Manifest.artifactIdentity?.weightCapsuleId);
...
assert.equal(
  af16Manifest.artifactIdentity?.weightCapsuleId,
  af32Manifest.artifactIdentity?.weightCapsuleId,
