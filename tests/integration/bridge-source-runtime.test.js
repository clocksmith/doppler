...
assert.ok(
  taskBundle.manifest.tensors['model.language_model.layers.0.self_attn.q_proj.weight']?.sourceTransform?.rowSumSource,
  'bridge LiteRT task bundle should preserve row-sum companions for packed rowwise tensors'
);
