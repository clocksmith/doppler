...
const [
  ...
  readJson(policy.weightIndex),
  readJson(policy.tensorPolicy),
  readJson(policy.tensorClosureReceipt),
  readJson(policy.sourceAcquisitionReceipt),
...
const incompleteAcquisition = { ...sourceAcquisitionReceipt, complete: false };
assert.throws(
  () => createManifestConversionPreflightReceipt({
    ...inputs,
    sourceAcquisitionReceipt: incompleteAcquisition,
  }),
