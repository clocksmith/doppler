...
function makeManifest(inference) {
  return {
    version: 1,
    modelId: 'test-model',
...
describe('manifest inference validation', () => {
  it('throws when normalization flags are missing', () => {
    ...
    delete inference.normalization.postAttentionNorm;
    delete inference.normalization.preFeedforwardNorm;
    delete inference.normalization.postFeedforwardNorm;
  ...
  it('treats null as explicit disable and undefined as missing', () => {
    ...
    delete withUndefined.attention.slidingWindow;
