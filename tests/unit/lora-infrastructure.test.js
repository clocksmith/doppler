...
function createTestLoRAManifest() {
...
describe('AdapterManifest', () => {
  ...
  describe('serializeManifest', () => {
    ...
    it('should throw on invalid manifest', () => {
      expect(() => serializeManifest({})).toThrow('Cannot serialize invalid manifest');
    });
...
describe('AdapterRegistry', () => {
  ...
  describe('register', () => {
    ...
    it('should reject invalid manifest', async () => {
      await expect(
        registry.register({}, { storageType: 'url', manifestPath: 'test' })
