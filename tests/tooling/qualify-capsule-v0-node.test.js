...
import {
  createCapsuleNodeQualificationReceipt,
  isSoftwareAdapter,
  withNodeCapsuleQualificationLifecycle,
} from '../../tools/qualify-capsule-v0-node.js';
...
assert.equal(receipt.schema, 'doppler.capsule-node-qualification/v2');
...
await assert.rejects(async () => createCapsuleNodeQualificationReceipt({
  capsule,
  session: {
    ...session,
...
console.log('✔ qualify-capsule-v0-node.test.js passed');
