...
const identity = "import { getShaderSourceIdentity as sourceId } from './shader-cache.js';";
assert.equal(inspectShaderCacheOwner(consumer + identity, 'fixture.js').guarded, false);
assert.equal(inspectShaderCacheOwner(consumer + identity + 'sourceId(file);', 'fixture.js').guarded, true);
