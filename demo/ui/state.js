export const state = {
  // Current hosted demo boot/run state.
  phase: 'booting',
  bootError: null,
  modelId: null,
  modelStatus: {},
  ...
  registeredModelIds: [],
  modelTypeCache: {},
  modelAvailability: { total: 0, run: 0, translate: 0, embedding: 0, diffusion: 0 },
  modeModelId: { run: null, translate: null, embedding: null, diffusion: null },
  ...
  kernelPathBuilderIndex: null,
  kernelPathBuilderLoading: false,
  kernelPathBuilderError: null,
  kernelPathBuilderModelId: null,
  kernelPathBuilderOverlayReport: null,
  kernelPathBuilderOverlaySource: null,
