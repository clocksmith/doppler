...
const body = `  <defs>
  <style>
    ...
    .title { font: 700 32px ${architectureUIFont}; }
    .section { font: 700 24px ${architectureUIFont}; }
    .node-title { font: 700 20px ${architectureUIFont}; }
    .node-text { font: 500 17px ${architectureUIFont}; }
    .code-text { font: 500 17px ${architectureMonoFont}; }
    .edge-label { font: 500 15px ${architectureUIFont}; fill: ${palette.muted}; }
...
${body}
  ...
  <rect x="70" y="70" width="610" height="560" rx="${radius.panel}" class="column-left" />
  <rect x="720" y="70" width="610" height="560" rx="${radius.panel}" class="column-right" />
  ...
  <rect x="125" y="150" width="500" height="82" rx="${radius.panel}" class="node node-load" />
  ...
  <rect x="125" y="270" width="500" height="72" rx="${radius.panel}" class="node node-load" />
  ...
  <rect x="125" y="380" width="500" height="82" rx="${radius.panel}" class="node node-load" />
  ...
  <rect x="125" y="520" width="240" height="82" rx="${radius.panel}" class="node node-load" />
  ...
  <rect x="385" y="520" width="240" height="82" rx="${radius.panel}" class="node node-load" />
  ...
  <rect x="775" y="150" width="500" height="82" rx="${radius.panel}" class="node node-infer" />
  ...
  <rect x="775" y="270" width="500" height="72" rx="${radius.panel}" class="node node-infer" />
  ...
  <rect x="775" y="380" width="500" height="104" rx="${radius.panel}" class="node node-infer" />
  ...
  <rect x="775" y="530" width="500" height="82" rx="${radius.panel}" class="node node-infer" />
