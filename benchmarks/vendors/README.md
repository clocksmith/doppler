...
- [schema/runtime-ownership-dimension-evidence.schema.json](./schema/runtime-ownership-dimension-evidence.schema.json): semantic evidence for each required ownership-decision dimension.
- [schema/runtime-ownership-hypothesis-evidence.schema.json](./schema/runtime-ownership-hypothesis-evidence.schema.json): derived material-advantage hypothesis results.
- [schema/runtime-ownership-promotion-evidence.schema.json](./schema/runtime-ownership-promotion-evidence.schema.json): human disposition promotion bound to the complete evidence and hypothesis sets.
