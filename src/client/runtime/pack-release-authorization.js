...
// One receipt/assignment boundary for every Pack operation; no model policy lives here.
export function createPackReleaseAuthorization(lifecycle) {
  ...
  function bindReceipt(receipt) {
    ...
    return freezePackV2({ ...bound, receiptDigest: computeCanonicalSha256(bound) });
  }
  return {
