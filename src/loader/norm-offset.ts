...
async function applyOffsetToGPUBuffer(
  tensor: GPUBuffer,
  options: GPUOffsetOptions
): Promise<NormOffsetResult> {
...
interface F32OffsetOptions {
  actualNumElements?: number;
  enableDebugLog: boolean;
  device: GPUDevice;
}

async function applyOffsetToFloat32Array(
  tensor: Float32Array,
  options: F32OffsetOptions
): Promise<NormOffsetResult> {
