...
export default {
  ...
  setTrace,
  getTrace,
  isTraceEnabled: (await import('./config.js')).isTraceEnabled,
  setBenchmarkMode,
  isBenchmarkMode,
  setGPUDevice: (await import('./config.js')).setGPUDevice,
  enableModules: (await import('./config.js')).enableModules,
  disableModules: (await import('./config.js')).disableModules,
  resetModuleFilters: (await import('./config.js')).resetModuleFilters,
  getLogHistory,
  clearLogHistory: (await import('./history.js')).clearLogHistory,
  printLogSummary,
  getDebugSnapshot,
  initFromUrlParams,
  LOG_LEVELS: (await import('./config.js')).LOG_LEVELS,
  TRACE_CATEGORIES: (await import('./config.js')).TRACE_CATEGORIES,
  // Completion signals
  SIGNALS,
  signalDone,
  signalResult,
