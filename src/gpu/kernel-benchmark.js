...
/** @type {Required<import('./kernel-benchmark.js').BenchmarkConfig>} */
 ...
 * @param {number[]} times
 * @returns {{median: number, min: number, max: number, p95: number, p99: number, stddev: number, mean: number}}
 */
 ...
 * @returns {{ gflops: number; theoretical: number }}
 */
function estimateFLOPS(kernel, config, latencyMs) {
  let flops = 0;
 ...
 * @param {number} warmupIterations
 * @param {number} timedIterations
 * @returns {Promise<import('./kernel-benchmark.js').KernelBenchmarkResult>}
 */
 ...
 * @param {number} N
 * @param {number} K
 * @param {import('./kernel-benchmark.js').BenchmarkConfig} [options]
 * @returns {Promise<import('./kernel-benchmark.js').KernelBenchmarkResult>}
 */
 ...
 * @param {number} K
 * @param {import('./kernel-benchmark.js').BenchmarkConfig} [options]
 * @returns {Promise<{separate: import('./kernel-benchmark.js').KernelBenchmarkResult, fused: import('./kernel-benchmark.js').KernelBenchmarkResult, comparison: import('./kernel-benchmark.js').BenchmarkComparison}>}
 */
export async function benchmarkMatmulRMSNormFused(
  ...
  /** @type {import('./kernel-benchmark.js').BenchmarkComparison} */
  const comparison = {
 ...
 * @param {import('./kernel-benchmark.js').BenchmarkConfig} [options]
 * @returns {Promise<import('./kernel-benchmark.js').BenchmarkReport>}
 */
export async function benchmarkDecodePass(
  ...
  /** @type {import('./kernel-benchmark.js').KernelBenchmarkResult[]} */
  const results = [];
  ...
  /** @type {import('./kernel-benchmark.js').BenchmarkReport} */
  const report = {
    device_info: {
      vendor: 'WebGPU',
 ...
 * @param {import('./kernel-benchmark.js').KernelBenchmarkResult} baseline
 * @param {import('./kernel-benchmark.js').KernelBenchmarkResult} optimized
 * @returns {import('./kernel-benchmark.js').BenchmarkComparison}
 */
 ...
 * @param {import('./kernel-benchmark.js').BenchmarkReport} report
 * @returns {string}
 */
export function exportBenchmarkJSON(report) {
