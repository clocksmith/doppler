 ...
 */
export function classifyTensor(name: string, modelType: ModelType): string {
 ...
 */
export function getGroupType(groupId: string, modelType: ModelType): ComponentGroupType {
 ...
 */
export function parseGroupLayerIndex(groupId: string): number | undefined {
 ...
 */
export function parseGroupExpertIndex(groupId: string): number | undefined {
