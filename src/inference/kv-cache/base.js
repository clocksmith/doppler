...
import {
  ...
  updateFromGPU as updateFromGPUImpl,
  recordUpdateFromGPU as recordUpdateFromGPUImpl,
  recordUpdateF32ToF16FromGPU as recordUpdateF32ToF16FromGPUImpl,
  recordF16UpdateAlreadyWrittenFromGPU as recordF16UpdateAlreadyWrittenFromGPUImpl,
  _updateContiguous as _updateContiguousImpl,
  _updatePaged as _updatePagedImpl,
} from './update.js';
...
export class KVCache {
  ...
  update(layerIdx, keys, values, startPos = this.currentSeqLen) {
    return updateImpl.call(this, layerIdx, keys, values, startPos);
  }

  
  updateFromGPU(layerIdx, keysBuffer, valuesBuffer, startPos, numTokens) {
    return updateFromGPUImpl.call(this, layerIdx, keysBuffer, valuesBuffer, startPos, numTokens);
  }

  
  recordUpdateFromGPU(recorder, layerIdx, keysBuffer, valuesBuffer, startPos, numTokens) {
    return recordUpdateFromGPUImpl.call(this, recorder, layerIdx, keysBuffer, valuesBuffer, startPos, numTokens);
  }

  async recordUpdateF32ToF16FromGPU(recorder, layerIdx, keysBuffer, valuesBuffer, startPos, numTokens) {
    return recordUpdateF32ToF16FromGPUImpl.call(this, recorder, layerIdx, keysBuffer, valuesBuffer, startPos, numTokens);
  }

  recordF16UpdateAlreadyWrittenFromGPU(layerIdx, startPos, numTokens) {
    return recordF16UpdateAlreadyWrittenFromGPUImpl.call(this, layerIdx, startPos, numTokens);
  }

  
  _updateContiguous(layer, keys, values, startPos, numNewTokens) {
    return _updateContiguousImpl.call(this, layer, keys, values, startPos, numNewTokens);
  }

  
  _updatePaged(layerIdx, layer, keys, values, startPos, numNewTokens) {
    return _updatePagedImpl.call(this, layerIdx, layer, keys, values, startPos, numNewTokens);
  }
