...
const FIELD_CASES = Object.freeze([
  ...
  { kind: 'nonNullable', path: ['ffn', 'branchMode'], message: 'ffn.branchMode is required' },
  ...
  { kind: 'nullable', path: ['rope', 'longropeShortFactor'], message: 'rope.longropeShortFactor must be explicitly set' },
  { kind: 'nullable', path: ['rope', 'longropeLongFactor'], message: 'rope.longropeLongFactor must be explicitly set' },
  { kind: 'nullable', path: ['rope', 'longropeOriginalMaxPos'], message: 'rope.longropeOriginalMaxPos must be explicitly set' },
  ...
  { kind: 'nullable', path: ['output', 'embeddingScale'], message: 'output.embeddingScale must be explicitly set' },
  { kind: 'nonNullable', path: ['output', 'logitInputScale'], message: 'output.logitInputScale is required' },
  ...
  { kind: 'nonNullable', path: ['layerPattern', 'residualBranchScale'], message: 'layerPattern.residualBranchScale is required' },
