...
- Catalog models: 19
- Source checkpoints: 13
- Conversion-only configs: 7
- HF-published catalog models: 10
- Runtime-verified catalog models: 17
- Benchmark-selected source architectures: 1
- Sources pending benchmark-selected architecture: 12
...
| medium | google/gemma-4-E2B-it | hf-publish | `node tools/publish-hf-registry-model.js --model-id gemma-4-e2b-it-q4k-ehf16-af16-int4ple --dry-run` |
| medium | google/gemma-4-12B-it | hf-publish | `node tools/publish-hf-registry-model.js --model-id gemma-4-12b-it-text-q4k-ehf16-af16 --dry-run` |
| large | google/gemma-4-12B-it-qat-w4a16-ct | hf-publish | `node tools/publish-hf-registry-model.js --model-id gemma-4-12b-it-text-w4a16-ct-ehf16-af16 --dry-run` |
...
| large | google/gemma-4-31B-it | hf-publish | `node tools/publish-hf-registry-model.js --model-id gemma-4-31b-it-text-q4k-ehf16-af16 --dry-run` |
