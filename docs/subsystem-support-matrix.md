...
| Root app-facing facade | `primary` | `tier1` | [README.md](../README.md), [docs/api/root.md](api/root.md), [src/capsule-runtime.js](../src/capsule-runtime.js) | Preferred Capsule-native application surface with explicit trust and injected execution ports. |
...
| Bun WebGPU host runtime | `secondary` | `experimental` | [docs/goals.md](goals.md), [docs/bun-product-qualification.md](bun-product-qualification.md), [docs/release-matrix.md](release-matrix.md) | Bun can execute the Node command surface with native WebGPU, but it remains experimental until the three-workload qualification policy has current semantic receipts, explicit human promotion, and synchronized support and release projections. |
...
| Legacy manifest-loading compatibility facade | `secondary` | `experimental` | [docs/api/compat.md](api/compat.md), [src/index.js](../src/index.js), [src/client/doppler-api.js](../src/client/doppler-api.js) | Explicit compatibility surface for legacy manifest loading and provider-oriented application APIs. |
...
| Root app-facing facade | `api` | yes | no | yes | [README.md](../README.md), [docs/api/root.md](api/root.md), [src/capsule-runtime.js](../src/capsule-runtime.js) | Preferred Capsule-native application surface with explicit trust and injected execution ports. |
...
| Tooling subpath | `api` | yes | no | yes | [docs/api/tooling-experimental.md](api/tooling-experimental.md), [docs/api/advanced-root-exports.md](api/advanced-root-exports.md), [src/tooling-exports.js](../src/tooling-exports.js) | Supported advanced surface for the tier1 command contract, diagnostics, storage, and registry tooling. Some helper groups exported on the same subpath remain experimental and are classified separately below. |
...
| Bun WebGPU host runtime | `runtime` | yes | no | no | [docs/goals.md](goals.md), [docs/bun-product-qualification.md](bun-product-qualification.md), [docs/release-matrix.md](release-matrix.md) | Bun can execute the Node command surface with native WebGPU, but it remains experimental until the three-workload qualification policy has current semantic receipts, explicit human promotion, and synchronized support and release projections. |
...
| Legacy manifest-loading compatibility facade | `api` | yes | no | yes | [docs/api/compat.md](api/compat.md), [src/index.js](../src/index.js), [src/client/doppler-api.js](../src/client/doppler-api.js) | Explicit compatibility surface for legacy manifest loading and provider-oriented application APIs. |
