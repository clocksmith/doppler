...
| Root app-facing facade | `primary` | `tier1` | [README.md](../README.md), [docs/api/root.md](api/root.md), [src/pack-runtime.js](../src/pack-runtime.js) | Preferred Pack-native application surface with explicit trust and injected execution ports. |
...
| Root app-facing facade | `api` | yes | no | yes | [README.md](../README.md), [docs/api/root.md](api/root.md), [src/pack-runtime.js](../src/pack-runtime.js) | Preferred Pack-native application surface with explicit trust and injected execution ports. |
