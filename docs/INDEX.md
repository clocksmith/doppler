...
- [WGSL Repair v13 Semantic Readiness](status/wgsl-repair-v13-semantic-readiness-2026-07-14.md) - passing adapter portability and reference dispatch mechanics admit frozen calibration/checkpoint selection; seed confirmation, promotion, and WGSL Doctor remain blocked.
