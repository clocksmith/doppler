...
| --- | --- | --- | --- |
| `doppler` | Deliver a reproducible open execution network with Poolday: verified useful execution across independent machines and admitted history improving later assignments. | [CATSCAN.md](../CATSCAN.md) | none |
