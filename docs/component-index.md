...
| --- | --- | --- | --- |
| `doppler` | Make local AI an ordinary JavaScript dependency. Prioritize copy-and-run local search; long-term success is independent adoption. | [CATSCAN.md](../CATSCAN.md) | none |
