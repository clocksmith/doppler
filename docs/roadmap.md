...
## Detailed Specs
- [Browser Training](../../../docs/archive/browser-training.md)
- [FunctionGemma Refactor](../../../docs/reploid/functiongemma.md)
- [GEPA Synergy](../../../docs/reploid/research/gepa-synergy.md)
