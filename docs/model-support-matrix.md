...
| qwen-3-5-0-8b-q4k-ehaf16 | qwen3 | text, vision | 2026-03-24 | browser, node | Browser/WebGPU headless Chromium on Apple M3 verified 2026-03-24: coherent sky-color output at 10.6 tok/s. Fixed: Q4K fused_matmul kernels, attention_streaming_f16kv, computePrecision f32, q4kLayout row. execution.inlineKernelPath=true, decodeLoop batchSize=4. |
| qwen-3-5-2b-q4k-ehaf16 | qwen3 | text, vision | 2026-03-24 | browser, node | Browser/WebGPU headless Chromium on Apple M3 verified 2026-03-24: coherent sky-color output at 6.9 tok/s. Fixed: 2B execution graph was using F16 kernels on Q4K shards (quantization header lied F16). Corrected to Q4_K_M with fused_matmul_q4 kernels, attention_streaming_f16kv, computePrecision f32, q4kLayout row. execution.inlineKernelPath=true. |
...
| qwen3 | transformer | active | 2 (src/config/conversion/qwen3/qwen-3-5-0-8b-q4k-ehaf16.json, src/config/conversion/qwen3/qwen-3-5-2b-q4k-ehaf16.json) | 2 (qwen-3-5-0-8b-q4k-ehaf16, qwen-3-5-2b-q4k-ehaf16) | yes | none | verified (2026-03-24) | verified | - |
