...
| gemma-3-1b-it-q4k-ehf16-af32 | gemma3 | run | 2026-03-20 | browser, node | Browser/WebGPU on Apple M3 and Node/WebGPU on AMD RDNA-3 re-verified through 2026-03-20 with deterministic greedy decoding. Produces correct blue sky-color answers on simple prompts. The lm_head_prefill phase-drop bug was the one confirmed runtime defect (now fixed and regression-covered). Q4K runtime path is functionally correct. |
| gemma-3-1b-it-f16-af32 | gemma3 | run | 2026-03-20 | browser, node | Browser/WebGPU on Apple M3 and Node/WebGPU on AMD RDNA-3 re-verified through 2026-03-20 with deterministic greedy decoding. Node smoke output remained coherent ('The sky is blue on a clear day.'). Fluency is stable; broader factual quality can still drift, but runtime behavior is correct and contracts pass. |
| translategemma-4b-it-q4k-ehf16-af32 | translategemma | run, translate | 2026-03-20 | browser, node | Browser/WebGPU on Apple M3 and Node/WebGPU on AMD RDNA-3 verified through 2026-03-20 with structured TranslateGemma requests. en->fr 'Hello world.' -> 'Bonjour le monde.' The working Q4K path is gemma3-q4k-dequant-f32w-f32a-online; the prior failure remained isolated to the older q4k_dequant F16-weight path. |
| translategemma-4b-1b-enes-q4k-ehf16-af32 | gemma3 | run, translate | 2026-03-20 | node | Node/WebGPU on AMD RDNA-3 re-verified on 2026-03-20 with structured TranslateGemma requests. EN->ES 'The weather is nice today.' -> 'El clima es agradable hoy.' Correct translation, coherent output. All execution-v0 contract checks pass. |
| qwen-3-5-0-8b-q4k-ehaf16 | qwen3 | run | 2026-03-20 | node | Node/WebGPU on AMD RDNA-3 re-verified on 2026-03-20 against the refreshed manifest now synced to the external volume. Deterministic greedy sky-color prompts remain coherent. Corrected RoPE fields remain in place and the manifest now stamps tieWordEmbeddings=true, a custom layerPattern, and execution.inlineKernelPath=false. |
| qwen-3-5-2b-q4k-ehaf16 | qwen3 | run | 2026-03-20 | node | Node/WebGPU on AMD RDNA-3 re-verified on 2026-03-20 against the refreshed manifest now synced to the external volume. Deterministic greedy sky-color prompts remain coherent. Corrected RoPE fields remain in place and the manifest now stamps tieWordEmbeddings=true, a custom layerPattern, and execution.inlineKernelPath=false. |
| lfm2-5-1-2b-instruct-q4k-ehf16-af32 | lfm2 | run | 2026-03-20 | node | Node/WebGPU on AMD RDNA-3 re-verified on 2026-03-20 after the ChatML fix and refreshed manifest sync. One-word sky-color prompts are stable ('Blue'), but short open-ended factual prompts remain prompt-sensitive and weaker than Gemma/Qwen. Runtime path is coherent; the refreshed manifest now includes tokenizer BOS/EOS/PAD IDs and decodeLoop=null. |
...
| gemma3 | transformer | active | 3 (src/config/conversion/gemma3/gemma-3-1b-it-f16-af32.json, src/config/conversion/gemma3/gemma-3-1b-it-q4k-ehf16-af32.json, src/config/conversion/gemma3/gemma-3-270m-it-q4k-ehf16-af32.json) | 4 (gemma-3-1b-it-f16-af32, gemma-3-1b-it-q4k-ehf16-af32, gemma-3-270m-it-q4k-ehf16-af32, +1 more) | yes | none | verified (2026-03-20) | verified | - |
...
| qwen3 | transformer | active | 2 (src/config/conversion/qwen3/qwen-3-5-0-8b-q4k-ehaf16.json, src/config/conversion/qwen3/qwen-3-5-2b-q4k-ehaf16.json) | 2 (qwen-3-5-0-8b-q4k-ehaf16, qwen-3-5-2b-q4k-ehaf16) | yes | none | verified (2026-03-20) | verified | - |
