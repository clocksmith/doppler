...
| qwen3-8-27b-text-f16-af32 | Text generators | qwen3 | text | 2026-08-23 | node | Node/WebGPU generated all 128 pinned greedy tokens with exact source parity, and the signed Pack v2 qualification passed. Evidence: reports/model-ir-v2/qwen3.8-27b.node-webgpu-qualification.json and reports/model-ir-v2/qwen3.8-27b.release-to-javascript-receipt.json. The artifact remains local-only until publication is separately approved. |
