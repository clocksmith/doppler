...
| qwen-3-5-0-8b-q4k-ehaf16 | qwen3 | text, vision | 2026-03-31 | browser, node | Node/WebGPU on Apple M3 verified 2026-04-01: GEMV decode + head256 prefill as primary execution graph (zero capability transforms on capable GPU). 21.5 tok/s decode, 69 tok/s prefill. execution.inlineKernelPath=true. |
| qwen-3-5-2b-q4k-ehaf16 | qwen3 | text, vision | 2026-03-31 | browser, node | Node/WebGPU on Apple M3 verified 2026-04-01: GEMV decode + head256 prefill as primary execution graph (zero capability transforms on capable GPU). execution.inlineKernelPath=true. |
...
| --- | --- | --- | --- |
| gemma-4-e2b-it-q4k-ehf16-af32 | catalog model | experimental | Cataloged model without a verified or failing inference lifecycle result. |
| gemma-4-e2b-it-text-q4k-ehf16-af32-rebuild-v4 | catalog model | experimental | Cataloged model without a verified or failing inference lifecycle result. |
...
| gemma4 | transformer | active | 2 (src/config/conversion/gemma4/gemma-4-e2b-it-q4k-ehf16-af32.json, src/config/conversion/gemma4/gemma-4-moe-q4k-ehf16-af32.json) | 2 (gemma-4-e2b-it-q4k-ehf16-af32, gemma-4-e2b-it-text-q4k-ehf16-af32-rebuild-v4) | no | none | unknown | verification-pending | not verified in catalog lifecycle |
