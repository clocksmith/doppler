...
| qwen-3-5-0-8b-q4k-ehaf16 | qwen3 | text | 2026-06-15 | browser, node | Browser/Node release evidence is package-visible at reports/release-claims/qwen-3-5-0-8b-q4k-ehaf16/2026-05-10T02-22-04.891Z.json. Qwen ChatML stop-token fixes remain local-catalog verified, but HF and quickstart availability stay disabled until the hosted artifact is republished with the explicit stop-token list. |
| qwen-3-5-2b-q4k-ehaf16 | qwen3 | text | 2026-06-15 | browser, node | Browser/Node release evidence is package-visible at reports/release-claims/qwen-3-5-2b-q4k-ehaf16/2026-05-03T02-33-21.397Z.json. The execution-v1 lane keeps the fixed fused-Q4 decode path and q4 LM-head/prefill kernels. HF and quickstart availability stay disabled until the hosted artifact is republished with the explicit stop-token list. |
...
| --- | --- | --- | --- | --- |
| gemma-4-12b-it-text-w4a16-ct-ehf16-af16 | gemma4 | text | active | Cataloged model without a passing or failing verification result yet. |
| gemma-4-31b-it-text-q4k-ehf16-af32 | gemma4 | text | active | Cataloged model without a passing or failing verification result yet. |
| gemma-4-31b-it-text-q4k-ehf16-af16 | gemma4 | text | active | Cataloged model without a passing or failing verification result yet. |
...
| Gemma 4 12B Unified | gap | unsupported | unsupported | unsupported | unsupported | yes | not_implemented | none | none | none | none | none | none | package-visible runtime receipt<br>browser receipt<br>electron receipt<br>doppler-serve quickstart lane<br>q4k correctness receipt<br>q4k benchmark receipt<br>mtp lane | browser-runtime-unsupported (browser, unsupported)<br>electron-runtime-unsupported (electron, unsupported)<br>node-runtime-unsupported (node, unsupported)<br>serve-runtime-unsupported (serve, unsupported)<br>runtime-receipt-missing (model, missing)<br>q4k-correctness-receipt-missing (model, missing)<br>q4k-benchmark-receipt-missing (benchmark, missing)<br>mtp-lane-not-implemented (mtp, not_implemented) |
| Gemma 4 31B | partially_verified | unverified | unverified | unverified | unsupported | yes | not_implemented | gemma-4-31b-it-text-q4k-ehf16-af16 (browser, pass) | none | none | none | gemma-4-31b-it-text-q4k-ehf16-af32 (experimental)<br>gemma-4-31b-it-text-q4k-ehf16-af16 (experimental) | none | AF16 release claim receipt<br>AF32 runtime pass receipt<br>electron receipt<br>doppler-serve quickstart lane<br>node receipt<br>mtp lane<br>current benchmark receipt | browser-release-claim-missing (browser, unverified)<br>electron-receipt-missing (electron, unverified)<br>af16-release-claim-missing (model, missing)<br>serve-quickstart-lane-missing (serve, unsupported)<br>node-receipt-missing (node, unverified)<br>af32-runtime-receipt-missing (model, missing)<br>mtp-lane-not-implemented (mtp, not_implemented)<br>current-benchmark-receipt-missing (benchmark, missing) |
...
| gemma3 | transformer | active | 3 (src/config/conversion/gemma3/gemma-3-1b-it-f16-af32.json, src/config/conversion/gemma3/gemma-3-1b-it-q4k-ehf16-af32.json, src/config/conversion/gemma3/gemma-3-270m-it-q4k-ehf16-af32.json) | 2 (gemma-3-1b-it-q4k-ehf16-af32, gemma-3-270m-it-q4k-ehf16-af32) | yes | none | verified (2026-06-24) | verified | catalog verification applies only to cataloged models (2/3 conversion configs cataloged) |
