...
| gemma-4-e2b-it-q4k-ehf16-af32 | gemma4 | text, vision | 2026-04-09 | node | Node/WebGPU on AMD RDNA-3 re-verified on 2026-04-09 after repinning Gemma 4 E2B text decode to attention_decode_online_f16kv and splitting prefill attention between sliding-window and full-attention layers. Produces coherent sky-color answers on simple prompts and now outpaces the local Transformers.js q4f16 WebGPU baseline on the matched text prompt. Republished to HF 2026-04-11. |
