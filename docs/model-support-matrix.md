...
| translategemma | transformer | active | 3 (tools/configs/conversion/gemma3/translategemma-4b-1b-enes-q4k-ehf16-af32.json, tools/configs/conversion/gemma3/translategemma-4b-it-f16-af32.json, tools/configs/conversion/gemma3/translategemma-4b-it-q4k-ehf16-af32.json) | 1 (translategemma-4b-it-q4k-ehf16-af32) | yes | none | verified (2026-03-17) | verified | catalog verification applies only to cataloged models (1/3 conversion configs cataloged) |
...
- Verified presets (active runtime + conversion + catalog + passing verification): 5
- Cataloged presets pending verification: 0
- Presets with HF-hosted catalog entries: 5
- Presets with verified catalog lifecycle: 5
- Presets with failed catalog verification: 0
