...
| qwen-3-5-0-8b-q4k-ehaf16 | qwen3 | text | 2026-07-13 | browser, node | The v1 manifest selects the Gemma sandwich-norm route instead of Qwen 3.5 residual addition followed by post-attention RMSNorm. Earlier browser/Node smokes therefore do not establish architectural correctness. See docs/status/qwen35-architecture-contract-correction-2026-07-13.md. A distinct v2 manifest must pass reference parity and runtime verification before relisting. |
| qwen-3-5-2b-q4k-ehaf16 | qwen3 | text | 2026-07-13 | browser, node | The v1 manifest selects the Gemma sandwich-norm route instead of Qwen 3.5 residual addition followed by post-attention RMSNorm. Earlier browser/Node smokes therefore do not establish architectural correctness. See docs/status/qwen35-architecture-contract-correction-2026-07-13.md. A distinct v2 manifest must pass reference parity and runtime verification before relisting. |
