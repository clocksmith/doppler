...
| qwen-3-5-0-8b-q4k-ehaf16 | qwen3 | text, vision | 2026-03-20 | node | Node/WebGPU on AMD RDNA-3 re-verified on 2026-03-20 against the refreshed manifest now synced to the external volume. Deterministic greedy sky-color prompts remain coherent. Corrected RoPE fields remain in place and the manifest now stamps tieWordEmbeddings=true, a custom layerPattern, and execution.inlineKernelPath=false. |
| qwen-3-5-2b-q4k-ehaf16 | qwen3 | text, vision | 2026-03-20 | node | Node/WebGPU on AMD RDNA-3 re-verified on 2026-03-20 against the refreshed manifest now synced to the external volume. Deterministic greedy sky-color prompts remain coherent. Corrected RoPE fields remain in place and the manifest now stamps tieWordEmbeddings=true, a custom layerPattern, and execution.inlineKernelPath=false. |
