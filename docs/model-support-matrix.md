...
| --- | --- | --- | --- | --- |
| gemma-3-270m-it-f16-af32 | gemma3 | text, vision | active | Cataloged model without a passing or failing verification result yet. |
...
| gemma3 | transformer | active | 5 (src/config/conversion/gemma3/gemma-3-1b-it-f16-af32.json, src/config/conversion/gemma3/gemma-3-1b-it-q4k-ehf16-af32.json, src/config/conversion/gemma3/gemma-3-270m-it-f16-af32.json, +2 more) | 3 (gemma-3-1b-it-q4k-ehf16-af32, gemma-3-270m-it-f16-af32, gemma-3-270m-it-q4k-ehf16-af32) | yes | none | partially verified (2/3) | verified | catalog verification applies only to cataloged models (3/5 conversion configs cataloged); partial verification (2/3 catalog models verified) |
