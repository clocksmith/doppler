...
| amplify-120m-f16-af32 | amplify | embedding | 2026-07-19 | node | Hosted Node/WebGPU sequence parity and synthetic q_proj LoRA lifecycle passed at docs/status/amplify-120m-sequence-hosted-webgpu-lora-qualification-2026-07-19.json. This is not a downstream biological-task quality claim. |
| esm2-t12-35m-ur50d-f32-af32 | esm | embedding | 2026-07-19 | node | Hosted Node/WebGPU sequence parity and synthetic q_proj LoRA lifecycle passed at docs/status/esm2-t12-35m-sequence-hosted-webgpu-lora-qualification-2026-07-19.json. The initial lane exposes embeddings, not masked-token logits or downstream biological quality. |
| esmc-300m-f32-af32 | esmc | embedding | 2026-07-19 | node | Hosted Node/WebGPU sequence parity and synthetic q_proj LoRA lifecycle passed at docs/status/esmc-300m-sequence-hosted-webgpu-lora-qualification-2026-07-19.json. The initial lane exposes embeddings, not masked-token logits or downstream biological quality. |
| nucleotide-transformer-v2-50m-f32-af32 | nucleotide-transformer | embedding | 2026-07-19 | node | Hosted Node/WebGPU sequence parity and synthetic q_proj LoRA lifecycle passed at docs/status/nucleotide-transformer-v2-50m-sequence-hosted-webgpu-lora-qualification-2026-07-19.json. The initial lane exposes embeddings, not masked-token logits or downstream biological quality; upstream use is CC-BY-NC-SA-4.0. |
