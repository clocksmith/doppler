...
Auto-generated from conversion configs (`src/config/conversion/**`), `models/catalog.json`, `models/model-type-taxonomy.json`, and `models/gemma4-targets.json`.
Run `npm run support:matrix:sync` after editing the catalog, taxonomy, Gemma 4 targets, or conversion configs.

Updated at: 2026-07-19

## Model Type Clusters

These clusters describe each RDRR artifact by domain, task, architecture role, and input/output contract. They are independent of model family, runtime `modelType`, and artifact-size tier.

| Type | Interface | Verified lanes | Other cataloged lanes |
| --- | --- | --- | --- |
| Text generators | text → text | gemma-3-1b-it-q4k-ehf16-af32<br>gemma-3-270m-it-f16-af32<br>gemma-3-270m-it-q4k-ehf16-af32<br>gemma-4-12b-it-text-q4k-ehf16-af16<br>gemma-4-12b-it-text-q4k-ehf16-af32<br>gemma-4-12b-it-text-w4a16-ct-ehf16-af16<br>gemma-4-31b-it-text-q4k-ehf16-af16<br>gemma-4-31b-it-text-q4k-ehf16-af32<br>qwen-3-5-0-8b-q4k-ehaf16<br>qwen-3-5-2b-q4k-ehaf16<br>qwen-3-6-27b-q4k-eaf16<br>qwen-3-6-27b-q4k-ehaf16<br>qwen3-8-27b-text-f16-af32 | lfm2-5-1-2b-instruct-q4k-ehf16-af32<br>minicpm4-0-5b-f16-af32<br>muse-glimmer-30b-text-bf16-af32<br>muse-glimmer-30b-text-f16-af32 |
| Multimodal generators | audio + image + text → text | gemma-4-e2b-it-q4k-ehf16-af16-int4ple<br>gemma-4-e2b-it-q4k-ehf16-af32<br>gemma-4-e2b-it-q4k-ehf16-af32-int4ple | none |
| Diffusion language models | text → text | none | diffusiongemma-26b-a4b-it-q4k-ehf16-af16 |
| Translation specialists | text → text | translategemma-4b-1b-enes-q4k-ehf16-af32<br>translategemma-4b-it-q4k-ehf16-af32 | none |
| Language embedders | text → pooled-embedding | google-embeddinggemma-300m-q4k-ehf16-af32<br>qwen-3-embedding-0-6b-q4k-ehf16-af32 | none |
| Rerankers | text-pair → relevance-score | qwen-3-reranker-0-6b-f16-af32<br>qwen-3-reranker-0-6b-q4k-ehf16-af32 | none |
| Protein encoders | protein-sequence → pooled-embedding + token-embedding + token-logits | amplify-120m-f16-af32<br>esm2-t12-35m-ur50d-f32-af32<br>esmc-300m-f32-af32 | none |
| Nucleotide encoders | dna-sequence → pooled-embedding + token-embedding | nucleotide-transformer-v2-50m-f32-af32 | none |
...
| --- | --- | --- | --- | --- | --- | --- |
| minicpm4-0-5b-f16-af32 | Text generators | minicpm | text | 2026-07-04 | node | Failure evidence: reports/release-claims/minicpm4-0-5b-f16-af32/2026-07-04T01-07-00.000Z.failed.json. The prompt "Q: What color is the sky on a clear day? A:" produced "This problem question: When是我国 an an", so the artifact remains local-only until tokenizer/template/config correctness is fixed. |
| muse-glimmer-30b-text-f16-af32 | Text generators | muse-glimmer | text | 2026-08-23 | node | The execution contract passes, but the retained F16 candidate diverges from the pinned source transcript at generated token index 7. Evidence: reports/model-ir-v2/glimmer-30b.node-candidate-11-f16kv-qualification.json. Keep this artifact local-only and unpromoted while physical parity is investigated. |
| muse-glimmer-30b-text-bf16-af32 | Text generators | muse-glimmer | text | 2026-08-23 | node | The execution contract passes and the BF16 candidate matches the pinned source through generated token index 6, then diverges at index 7. Evidence: reports/model-ir-v2/glimmer-30b.node-candidate-24-bf16w-qualification.json. Keep this artifact local-only and unpromoted while physical parity is investigated. |
...
| qwen3 | transformer | active | 13 (src/config/conversion/qwen3/qwen-3-5-0-8b-q4k-ehaf16.json, src/config/conversion/qwen3/qwen-3-5-2b-q4k-ehaf16.json, src/config/conversion/qwen3/qwen-3-5-9b-f16-af32.json, +10 more) | 8 (qwen-3-5-0-8b-q4k-ehaf16, qwen-3-5-2b-q4k-ehaf16, qwen-3-6-27b-q4k-eaf16, +5 more) | yes | none | verified (2026-08-23) | verified | catalog verification applies only to cataloged models (8/13 conversion configs cataloged) |
...
| muse-glimmer | transformer | active | 2 (src/config/conversion/muse-glimmer/muse-glimmer-30b-text-bf16-af32.json, src/config/conversion/muse-glimmer/muse-glimmer-30b-text-f16-af32.json) | 2 (muse-glimmer-30b-text-bf16-af32, muse-glimmer-30b-text-f16-af32) | no | none | failed | verification-failed | - |
