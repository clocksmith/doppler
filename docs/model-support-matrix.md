...
| gemma-4-e2b-it-q4k-ehf16-af32 | gemma4 | text, vision | 2026-04-20 | browser, node | Browser/WebGPU on AMD Strix Halo / Radeon 8060S re-verified 2026-04-20 with release decode cadence. Compare receipts benchmarks/vendors/results/compare_20260420T162522.json (t=0 greedy) and benchmarks/vendors/results/compare_20260420T162831.json (t=1 topK50) show Doppler decode throughput ahead of the paired Transformers.js ONNX/q4f16 runner on warm OPFS. Apple M3 / Node WebGPU darwin execution contract pass remains from reports/gemma-4-e2b-it-q4k-ehf16-af32/2026-04-18T19-17-45.997Z.json. Manifest-only republish to HF 2026-04-18 at revision c690ac0274891afbddb8afb776d000e4c0051b7b. |
...
| qwen-3-5-0-8b-q4k-ehaf16 | qwen3 | text, vision | 2026-04-20 | browser, node | Browser/WebGPU on AMD Strix Halo / Radeon 8060S re-verified 2026-04-20 after the quantized tied-LM-head update. Compare receipts benchmarks/vendors/results/compare_20260420T163342.json (t=0 greedy) and benchmarks/vendors/results/compare_20260420T163425.json (t=1 topK50) show Doppler decode throughput ahead of the paired Transformers.js runner on warm OPFS. Earlier 2026-04-18 Node/WebGPU verification after the Qwen prefill kernel-ref swap remains valid; execution contract gate pass. Manifest-only republish to HF 2026-04-18 at revision 1c509e37e4430d7ffd094ce5dfa623792603670e. |
| qwen-3-5-2b-q4k-ehaf16 | qwen3 | text, vision | 2026-04-20 | browser, node | Browser/WebGPU on AMD Strix Halo / Radeon 8060S re-verified 2026-04-20 after the Qwen 3.5 2B retune; execution contract pass with manifest-owned decodeBatchSize=12. Receipt: reports/qwen-3-5-2b-q4k-ehaf16/2026-04-20T12-49-30.650Z.json. Current execution-v1 uses the fixed fused-Q4 main_gemv transformer decode path, keeps stable fused-Q4 main_multicol declared as fallback, upgrades the tied LM head to Q4 via optimized lm_head_q4 GEMV 64x4, upgrades prefill projections to q4_widetile, and upgrades prefill attention to attn_head256. Compare receipts benchmarks/vendors/results/compare_20260420T163143.json (t=0 greedy) and benchmarks/vendors/results/compare_20260420T163255.json (t=1 topK50, run with --allow-non-comparable-lane because the lane remains capability_only) show Doppler decode throughput ahead of the paired Transformers.js runner on warm OPFS. Manifest-only republish to HF 2026-04-18 at revision 3f54bc54c19181bd737d1773dcd70fb783297e73. |
...
| gemma4 | transformer | active | 3 (src/config/conversion/gemma4/gemma-4-e2b-it-q4k-ehf16-af32-int4ple.json, src/config/conversion/gemma4/gemma-4-e2b-it-q4k-ehf16-af32.json, src/config/conversion/gemma4/gemma-4-moe-q4k-ehf16-af32.json) | 2 (gemma-4-e2b-it-q4k-ehf16-af32, gemma-4-e2b-it-q4k-ehf16-af32-int4ple) | yes | none | verified (2026-04-20) | verified | catalog verification applies only to cataloged models (2/3 conversion configs cataloged) |
| qwen3 | transformer | active | 2 (src/config/conversion/qwen3/qwen-3-5-0-8b-q4k-ehaf16.json, src/config/conversion/qwen3/qwen-3-5-2b-q4k-ehaf16.json) | 2 (qwen-3-5-0-8b-q4k-ehaf16, qwen-3-5-2b-q4k-ehaf16) | yes | none | verified (2026-04-20) | verified | - |
