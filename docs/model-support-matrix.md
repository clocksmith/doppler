...
| gemma-4-e2b-it-q4k-ehf16-af32 | gemma4 | text, vision | 2026-04-15 | browser, node | Node/WebGPU on AMD RDNA-3 re-verified on 2026-04-09 after repinning Gemma 4 E2B text decode to attention_decode_online_f16kv and splitting prefill attention between sliding-window and full-attention layers. Produces coherent sky-color answers on simple prompts. Apple M3 browser compare (2026-04-15, receipt `benchmarks/vendors/results/compare_20260415T170108.json`): Doppler RDRR wins cold model load ~3.4x (16.97s vs 57.48s) and ties warm load; Transformers.js ONNX/q4f16 wins decode throughput ~2.6x (29.3 tok/s vs 11.45 tok/s warm) and TTFT ~5.5x (208ms vs 1143ms warm). Product-engine comparison, format delta disclosed. Republished to HF 2026-04-11. |
...
| gemma4 | transformer | active | 2 (src/config/conversion/gemma4/gemma-4-e2b-it-q4k-ehf16-af32.json, src/config/conversion/gemma4/gemma-4-moe-q4k-ehf16-af32.json) | 1 (gemma-4-e2b-it-q4k-ehf16-af32) | yes | none | verified (2026-04-09) | verified | catalog verification applies only to cataloged models (1/2 conversion configs cataloged) |
