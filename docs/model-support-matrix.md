...
| qwen3_5 | preset family | conversion-ready | conversion configs exist, but there is no cataloged model entry yet |
...
| qwen3 | transformer | active | 1 (tools/configs/conversion/qwen3/qwen3-template-q4k.json) | 2 (qwen-3-5-0-8b-q4k-ehaf16, qwen-3-5-2b-q4k-ehaf16) | no | none | failed | verification-failed | - |
