const PROGRAM_LENGTH = 55u;
const P = array<u32, PROGRAM_LENGTH>(21331,0,52,1,2,20,0,1,3,0,0,1,4,1,0,1,5,1,0,14,2,0,0,3,6,3,4,2,3,4,0,2,4,6,0,4,2,2,5,15,0,0,0,13,3,0,0,1,7,10,0,12,7,0,0);
