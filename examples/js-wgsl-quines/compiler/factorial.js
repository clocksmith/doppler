(() => {
"use strict";
const PROGRAM_LENGTH = 43;
const P = Object.freeze([21331,0,40,1,2,10,0,1,3,1,0,1,4,1,0,14,2,0,0,5,3,3,2,4,2,2,4,15,0,0,0,13,3,0,0,1,5,10,0,12,5,0,0]);
